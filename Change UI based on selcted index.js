//create a selected array, that holds the selected numbers
//change the opacity of the selected number, by adding a new style object
//respect index 0 and 4 and change the opacity
